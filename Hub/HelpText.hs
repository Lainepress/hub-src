...
helpText = unlines
    ...
    , "hub lock           [<hub>]"
    , ""
    , "      Locks a hub so that it can not be removed nor can packages be added nor"
    , "      removed."
    , ""
    , "      (See 'hub set' on how to set the current hub.)"
    , ""
    ...
    , "hub save           [<u-hub>]"
    , "        "
    , "      Save out the configuration of the named hub (or the default hub) onto"
    , "      standard output."
    , ""
    , "      (See 'hub set' on how to set the current hub.)"
    , ""
    , "hub load           [<u-hub>]"
    , ""
    , "      Load the hub <u-hub> from standard input. If the named hub doesn't"
    ...
    , "      global hub specified and removed and recreated referencing the right"
    , "      global hub if it isn't."
    , "      "
